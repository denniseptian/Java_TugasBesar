...
public class data {
	...
	public String getPosisi_stop_kontak() {
		return posisi_stop_kontak;
	}
	public void setPosisi_stop_kontak(String posisi_stop_kontak) {
		this.posisi_stop_kontak = posisi_stop_kontak;
	}
